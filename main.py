...
def run() -> int:
    ...
    for topic in unique_topics:
        ...
        ranked_candidates.append(
            RankedCandidate(
                ...
                preview_image1_path=render_result.slide1_path,
                preview_image2_path=render_result.slide2_path,
                preview_image3_path=render_result.slide3_path,
                source=topic.source,
    ...
    ranked_candidates = [
        RankedCandidate(
            ...
            preview_image1_path=item.preview_image1_path,
            preview_image2_path=item.preview_image2_path,
            preview_image3_path=item.preview_image3_path,
            source=item.source,
